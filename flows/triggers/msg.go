...
func NewMsg(env envs.Environment, flow *assets.FlowReference, contact *flows.Contact, msg *flows.MsgIn, match *KeywordMatch, params *types.XObject) flows.Trigger {
	return &MsgTrigger{
		baseTrigger: newBaseTrigger(TypeMsg, env, flow, contact, nil, params),
		msg:         msg,
		match:       match,
	}
}
